...
run_2km='/project/pr04/banni/results_PGW/PGW/lm_f/'
run_2km='/project/pr04/banni/results_PGW/PGWcontinue/lm_f/'
output_path=run_2km#+'regrided_12km/'
output_path='/store/c2sm/pr04/jvergara/DAVID_REGRIDED/'
output_path='/store/c2sm/pr04/NIKOLINA_REGRIDED/'
